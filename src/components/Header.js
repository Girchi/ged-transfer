            ...
            <div className='max-w-[1344px] mx-auto flex items-center justify-between'>
                ...
                <div className="flex gap-8">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            className="flex justify-center items-center bg-secondaryGreen rounded-[32px] cursor-pointer py-2 px-4 ">
                            <span className="font-medium text-sm leading-6 tracking-[0.02em] text-white">ავტორიზაცია</span>
                        </button>
