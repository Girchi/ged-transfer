const NextButton = (props) => {
    ...
    return (
        <div onClick={handleClick} className={'flex justify-center ml-auto items-center py-2 px-4 gap-1 w-[111px] h-10 rounded-[32px]' + bgColor + txtColor + cursor }>
